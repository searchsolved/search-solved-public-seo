...
archive_url_list = df_archive_urls['Extracted Archive URL']
archive_h1_list = []
...
df_archive.to_csv('/python_scripts/df_archive-138.csv')  # todo remove
...
df_matches.to_csv('/python_scripts/df_matches.csv')  #todo remove
