...
with st.expander("How to use this tool"):
    ...
    **What this tool does:**
    ...
    - Generates social posts, emails, summaries
    - Uses AI to adapt content for various channels

    **How to use:**
    1. Enter your OpenAI API key
    2. Paste or upload your source content
    3. Select output formats (social, email, etc.)
    4. Generate repurposed versions
